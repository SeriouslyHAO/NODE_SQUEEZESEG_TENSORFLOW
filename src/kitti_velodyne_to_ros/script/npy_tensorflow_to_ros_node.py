...
class NPY_TENSORFLOW_TO_ROS():
    ...
    def prediction_publish(self, idx):
        ...
        print 'record ' + str(record.shape)


        lidar = record[:,:,:5]

        print 'lidar ' + str(lidar.shape)
        print 'lidar[0][0] ' + str(lidar[0][0])
        ...
        print 'lidar_mask ' + str(lidar_mask.shape)
        ...
        print 'norm_lidar ' + str(norm_lidar.shape)
        print 'norm_lidar[0][0] ' + str(norm_lidar[0][0])
